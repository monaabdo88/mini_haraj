        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Posts Trash</strong>
                </div>
                <div class="card-body">
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('posts.restore',['id'=>$post->id])}}" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
                                    <a href="{{ route('posts.kill',['id'=>$post->id]) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>

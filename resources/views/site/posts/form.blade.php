<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
    <label for="name" class="col-md-4 text-center">Post Name</label>
    <div class="col-md-8">
...
<div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
    <label for="desc" class="col-md-4 text-center">Post Content</label>
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    <label for="name" class="col-md-4 text-center">Post Status</label>
    ...
    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
        <label for="name" class="col-md-4 text-center">Post Tags</label>
        <div class="clearfix"></div>
        <div class="col-md-8 pull-right">
            @foreach($tags as $tag)
                <div class="col-md-3">
                <input type="checkbox" class="pull-left" style="width: 15%" name="tags[]" value="{{$tag->id}}"
                @if(isset($post->tags))
                            ...
                            @endforeach
                        @endif
                > <span class="pull-right">{{$tag->tag}}</span></div>
            @endforeach
        </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
        <label for="image" class="col-md-4 text-center">Post Image</label>
